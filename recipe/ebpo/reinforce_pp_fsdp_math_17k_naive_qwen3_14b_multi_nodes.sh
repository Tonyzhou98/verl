...
#SBATCH --job-name=ebpo_qwen3_14b_rl_reinforce_pp_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_reinforce_pp.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_reinforce_pp.stderr
...
experiment_name="ebpo_qwen3_14b_rl_reinforce_pp_fsdp_multi_nodes"
