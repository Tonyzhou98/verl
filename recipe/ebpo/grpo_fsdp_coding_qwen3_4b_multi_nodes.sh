...
#SBATCH --job-name=qwen3_4b_rl_grpo_coding_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/qwen3_4b_rl_grpo_coding.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/qwen3_4b_rl_grpo_coding.stderr
...
experiment_name="qwen3_4b_rl_grpo_coding_fsdp_multi_nodes"
