...
#SBATCH --job-name=ebpo_qwen3_14b_base_rl_ebpo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_base_rl_ebpo_sorted.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_base_rl_ebpo_sorted.stderr
...
experiment_name="ebpo_qwen3_14b_base_rl_ebpo_sorted_fsdp_multi_nodes"
