...
#SBATCH --job-name=ebpo_qwen3_8b_rl_ebpo_coding_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_ebpo_coding.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_ebpo_coding.stderr
...
experiment_name="ebpo_qwen3_8b_rl_ebpo_coding_fsdp_multi_nodes"
