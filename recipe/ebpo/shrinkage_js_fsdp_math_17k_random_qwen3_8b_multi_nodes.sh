...
#SBATCH --job-name=ebpo_qwen3_8b_rl_shrinkagejs_random_fsdp_multi_nodes
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_shrinkagejs_random_fsdp_multi_nodes.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_shrinkagejs_random_fsdp_multi_nodes.stderr
...
experiment_name="ebpo_qwen3_8b_rl_shrinkagejs_random_fsdp_multi_nodes"
