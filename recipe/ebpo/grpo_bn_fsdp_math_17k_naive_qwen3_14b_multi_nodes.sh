...
#SBATCH --job-name=ebpo_qwen3_14b_rl_grpo_bn_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_grpo_bn.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_grpo_bn.stderr
...
experiment_name="ebpo_qwen3_14b_rl_grpo_bn_fsdp_multi_nodes"
