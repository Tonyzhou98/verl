...
#SBATCH --job-name=ebpo_qwen3_14b_base_rl_drgrpo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_base_rl_drgrpo_sorted.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_base_rl_drgrpo_sorted.stderr
...
experiment_name="ebpo_qwen3_14b_base_rl_drgrpo_sorted_fsdp_multi_nodes"
ROOT_DIR=/fsx/zyhang/verl
CHECKPOINT_PATH=/checkpoints/zyhang
MODEL_PATH=/fsx/zyhang/Qwen/Qwen3-14B-base
