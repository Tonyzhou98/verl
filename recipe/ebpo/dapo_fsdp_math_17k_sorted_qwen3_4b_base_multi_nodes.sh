...
#SBATCH --job-name=qwen3_4b_rl_dapo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_4b_rl_dapo_sorted.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_4b_rl_dapo_sorted.stderr
...
experiment_name="qwen3_4b_rl_dapo_sorted_fsdp_multi_nodes"
ROOT_DIR=/fsx/zyhang/verl
CHECKPOINT_PATH=/checkpoints/zyhang
MODEL_PATH=/fsx/zyhang/Qwen/Qwen3-4B
...
source /home/zyhang/miniconda3/etc/profile.d/conda.sh
conda activate ebpo
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files="$DATA_PATH/dapo-math-17k-unique-sorted.parquet" \
