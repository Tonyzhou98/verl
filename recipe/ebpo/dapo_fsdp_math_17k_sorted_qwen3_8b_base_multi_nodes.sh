...
#SBATCH --job-name=ebpo_qwen3_8b_base_rl_dapo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_base_rl_dapo_sorted.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_base_rl_dapo_sorted.stderr
...
experiment_name="ebpo_qwen3_8b_base_rl_dapo_sorted_fsdp_multi_nodes"
