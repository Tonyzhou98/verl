...
#SBATCH --job-name=qwen3_1_7b_rl_grpo_coding_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/qwen3_1_7b_rl_grpo_coding.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/qwen3_1_7b_rl_grpo_coding.stderr
...
# Increase NCCL collective timeout to tolerate transient EFA hangs
export NCCL_TIMEOUT_S=3600
export TORCH_NCCL_BLOCKING_WAIT=1
export NCCL_HEARTBEAT_TIMEOUT_SEC=1200
...
experiment_name="qwen3_1_7b_rl_grpo_coding_fsdp_multi_nodes"
ROOT_DIR=/fsx/zyhang/verl
CHECKPOINT_PATH=/checkpoints/zyhang
MODEL_PATH=/fsx/zyhang/Qwen/Qwen3-1.7B
DATA_PATH=/fsx/zyhang/verl/recipe/ebpo/prime-rl


mkdir -p logs/${project_name}
# Do NOT wipe checkpoints on resubmit — needed for resume_mode=auto
