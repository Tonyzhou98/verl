...
#SBATCH --job-name=ebpo_qwen3_14b_rl_drgrpo_coding_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_drgrpo_coding.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_drgrpo_coding.stderr
...
experiment_name="ebpo_qwen3_14b_rl_drgrpo_coding_fsdp_multi_nodes"
