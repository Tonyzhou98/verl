...
#SBATCH --job-name=qwen3_1_7b_base_rl_grpo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_1_7b_base_rl_grpo.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_1_7b_base_rl_grpo.stderr
...
experiment_name="qwen3_1_7b_rl_grpo_sorted_fsdp_multi_nodes"
