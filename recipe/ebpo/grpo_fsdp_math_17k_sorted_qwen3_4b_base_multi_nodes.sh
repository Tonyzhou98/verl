...
#SBATCH --job-name=qwen3_4b_base_rl_grpo_sorted_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_4b_base_rl_grpo.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_4b_base_rl_grpo.stderr
...
experiment_name="qwen3_4b_rl_grpo_sorted_fsdp_multi_nodes"
