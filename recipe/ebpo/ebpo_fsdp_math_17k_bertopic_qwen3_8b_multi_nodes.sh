...
#SBATCH --job-name=ebpo_qwen3_8b_rl_ebpo_bertopic_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_ebpo_bertopic.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_ebpo_bertopic.stderr
...
experiment_name="ebpo_qwen3_8b_rl_ebpo_bertopic_fsdp_multi_nodes"
