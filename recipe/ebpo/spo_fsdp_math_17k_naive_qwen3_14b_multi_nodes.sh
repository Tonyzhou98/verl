...
#SBATCH --job-name=ebpo_qwen3_14b_rl_spo_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_spo.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_spo.stderr
...
experiment_name="ebpo_qwen3_14b_rl_spo_fsdp_multi_nodes"
