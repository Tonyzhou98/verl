...
#SBATCH --job-name=ebpo_qwen3_8b_rl_rloo_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_rloo.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_8b_rl_rloo.stderr
...
experiment_name="ebpo_qwen3_8b_rl_rloo_fsdp_multi_nodes"
