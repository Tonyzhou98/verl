...
#SBATCH --job-name=ebpo_qwen3_14b_rl_shrinkagejs_topic_fsdp_multi_nodes
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_shrinkagejs_topic_fsdp_multi_nodes.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_shrinkagejs_topic_fsdp_multi_nodes.stderr
...
project_name="ebpo"
algorithm=shrinkage_js
rollout_n=4
k_max=8
loss_agg_mode="token-mean"
experiment_name="ebpo_qwen3_14b_rl_shrinkagejs_topic_fsdp_multi_nodes"
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files="$DATA_PATH/dapo-math-17k-unique-bertopic.parquet" \
