...
#SBATCH --job-name=ebpo_qwen3_14b_rl_grpo_fsdp
#SBATCH --output=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_grpo.stdout
#SBATCH --error=/fsx/zyhang/verl/slurm/ebpo_qwen3_14b_rl_grpo.stderr
...
experiment_name="ebpo_qwen3_14b_rl_ebpo_fsdp_multi_nodes"
